...
## Project Structure
    ...
    ├── best_medical_academ_36515  # Django project configurations
...
1. Clone this repo and `cd best_medical_academ_36515`
...
2. Clone this repo and `cd best_medical_academ_36515`
